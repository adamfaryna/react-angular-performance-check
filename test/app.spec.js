...
describe('app', () => {
	describe('"defaults" property', () => {
		it('should contain property "iterations" equal "2"', () => {
			expect(app.defaults.iterations).to.be.equal(2);
		});

		it('should contain property "dataSetSize" equal "10"', () => {
			expect(app.defaults.dataSetSize).to.be.equal(10);
		});
	});
